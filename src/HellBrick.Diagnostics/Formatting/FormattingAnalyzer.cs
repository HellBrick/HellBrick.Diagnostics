	...
	public class FormattingAnalyzer : DiagnosticAnalyzer
	{
		...
		private void FindInvalidFormatting( SyntaxTreeAnalysisContext context )
		{
			try
			{
				...
				if ( HasGeneratedCodeAttribute( root ) || HasAutoGeneratedComment( root ) )
					return;
		...
		private bool HasAutoGeneratedComment( SyntaxNode root ) => root.DescendantTrivia().Any( t => t.ToString().StartsWith( "// <auto-generated" ) );
